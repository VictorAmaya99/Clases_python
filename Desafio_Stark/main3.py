...
def extraer_iniciales(nombre_heroe:str)->str:
    ...
    for heroe in lista_personajes:
        ...
        sin_guion = nombre_heroe.replace("-", " ")
        sin_the = sin_guion.replace("the", " ")
        
        nombres = sin_the.split()
...
#def definir_iniciales_nombre(heroe:dict, iniciales:extraer_iniciales)->dict:
